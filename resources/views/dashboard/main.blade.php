...
<html>
 ...
 <head>
    ...
    <title>Marriage Portal- Dashboard</title>
    <!-- Bootstrap Core CSS -->
    <link  rel="stylesheet" type="text/css" href="{{URL::asset('css/dashboard/bootstrap/dist/css/bootstrap.min.css')}}">
    <link rel="stylesheet" type="text/css" href="{{URL::asset('css/auth/css/fonts/font-awesome-4.7.0/css/font-awesome.min.css')}}">
    <!-- Menu CSS -->
    <link  rel="stylesheet" type="text/css" href="{{URL::asset('plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.css')}}">
    <!-- toast CSS -->
    <link  rel="stylesheet" type="text/css" href="{{URL::asset('plugins/bower_components/toast-master/css/jquery.toast.css')}}">
    <!-- morris CSS -->
    <link  rel="stylesheet" type="text/css" href="{{URL::asset('plugins/bower_components/morrisjs/morris.css')}}">
    <!-- chartist CSS -->
    <link  rel="stylesheet" type="text/css" href="{{URL::asset('plugins/bower_components/chartist-js/dist/chartist.min.css')}}">
    <link  rel="stylesheet" type="text/css" href="{{URL::asset('plugins/bower_components/chartist-plugin-tooltip-master/dist/chartist-plugin-tooltip.css')}}">
    <!-- animation CSS -->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('css/dashboard/css/animate.css')}}">
    <!-- Custom CSS -->
    <link rel="stylesheet" type="text/css" href="{{URL::asset('css/dashboard/css/style.css')}}">
    <!-- color CSS -->
    <link href="{{URL::asset('css/dashboard/css/colors/default.css')}}" id="theme" rel="stylesheet">
...
<body class="fix-header">
            ...
            <div class="navbar-header">
                <div class="top-left-part">
                    ...
                    <a class="logo" href="index.html">
                        ...
                        <!--This is dark logo text--><img src="{{URL::asset('img/home/img/Invitation-Card.png')}}" alt="home" class="dark-logo" /><!--This is light logo text--><img src="{{URL::asset('img/home/img/Invitation-Card.png')}}" alt="home" class="light-logo" />
                     </span> </a>
                </div>
                <!-- /Logo -->
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        <a class="profile-pic" href="#"> <img src="{{URL::asset('plugins/images/users/varun.jpg')}}"  alt="user-img" width="36" class="img-circle"><b class="hidden-xs">{{ Auth::user()->name }}</b></a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-header -->
            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    ...
                    <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
                    	<a class="btn btn-danger pull-right m-l-20 hidden-xs hidden-sm waves-effect waves-light" href="{{ route('logout') }}"
					    onclick="event.preventDefault();
					             document.getElementById('logout-form').submit();">
					    Logout
					</a>
                        ...
                        <div class="white-box">
                            ...
                            <div class="comment-center p-t-10">
                                <div class="comment-body">
                                    <div class="user-img"> <img src="{{URL::asset('plugins/images/users/pawandeep.jpg')}}" alt="user" class="img-circle">
                                    </div>
                                ...
                                <div class="comment-body">
                                    <div class="user-img"> <img src="{{URL::asset('plugins/images/users/sonu.jpg')}}" alt="user" class="img-circle">
                                    </div>
                                    <div class="mail-contnet">
                                ...
                                <div class="comment-body b-none">
                                    <div class="user-img"> <img src="{{URL::asset('plugins/images/users/arijit.jpg')}}" alt="user" class="img-circle">
                                    </div>
                                    <div class="mail-contnet">
    ...
    <script src="{{URL::asset('css/dashboard/bootstrap/dist/js/bootstrap.min.js')}}"></script>
    <!-- Menu Plugin JavaScript -->
    <script src="{{URL::asset('plugins/bower_components/sidebar-nav/dist/sidebar-nav.min.js')}}"></script>
    <!--slimscroll JavaScript -->
    <script src="{{URL::asset('js/dashboard/js/jquery.slimscroll.js')}}"></script>
    <!--Wave Effects -->
    <script src="{{URL::asset('js/dashboard/js/waves.js')}}"></script>
    <!--Counter js -->
    ...
    <script src="{{URL::asset('js/dashboard/js/custom.min.js')}}"></script>
    <script src="{{URL::asset('js/dashboard/js/dashboard1.js')}}"></script>
